...
public final class IntentLauncher {
    ...
    /**
     * 参数key一定是 Const.KEY_INTENT_JUMP_DATA
     */
    public void launchWithOneStrParam(String paramValue, Class<?> cls) {
        mIntent.putExtra(Const.KEY_INTENT_JUMP_DATA, paramValue);
        launch(cls);
    }
